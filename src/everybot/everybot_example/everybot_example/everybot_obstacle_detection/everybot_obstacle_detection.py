...
class EverybotObstacleDetection(Node):

    def __init__(self):
        super().__init__('everybot_obstacle_detection')
        ...
        ************************************************************"""
        ...
        self.get_logger().info("everybot obstacle detection node has been initialised.")
