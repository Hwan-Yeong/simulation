...
class EverybotPatrolClient(Node):

    def __init__(self):
        super().__init__('everybot_patrol_client')
        ...
        ************************************************************"""
        ...
        self.get_logger().info("Everybot patrol node has been initialised.")
