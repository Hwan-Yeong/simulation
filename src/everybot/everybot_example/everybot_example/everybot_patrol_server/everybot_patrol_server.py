...
from everybot_example.everybot_patrol_server.everybot_path \
    import EverybotPath
from everybot_msgs.action import Patrol


class EverybotPatrolServer(Node):

    def __init__(self):
        super().__init__('everybot_patrol_server')
        ...
        ************************************************************"""
        ...
        self.get_logger().info("Everybot patrol action server has been initialised.")
    ...
    *******************************************************************************"""
    ...
    async def execute_callback(self, goal_handle):
        ...
        while (feedback_msg.left_time > 0):
            ...
            # Give vel_cmd to Everybot
            twist = Twist()
            twist = EverybotPath.drive_circle(radius, speed)
