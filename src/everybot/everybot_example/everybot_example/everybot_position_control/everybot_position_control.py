...
from everybot_example.everybot_position_control.everybot_path import EverybotPath

terminal_msg = """
Everybot Position Control
------------------------------------------------------
...
class EverybotPositionControl(Node):

    def __init__(self):
        super().__init__('everybot_position_control')
        ...
        ************************************************************"""
        ...
        self.get_logger().info("Everybot position control node has been initialised.")
    ...
    def generate_path(self):
        ...
        if self.get_key_state is False:
            ...
            if self.step == 1:
                ...
                twist, self.step = EverybotPath.turn(angle, angular_velocity, self.step)
            ...
            # Step 2: Go Straight
                ...
                twist, self.step = EverybotPath.go_straight(distance, linear_velocity, self.step)
