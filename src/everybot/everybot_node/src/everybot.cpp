...
using everybot::everybot::Everybot;
using namespace std::chrono_literals;

Everybot::Everybot(const std::string & usb_port)
: Node("everybot_node", rclcpp::NodeOptions().use_intra_process_comms(true))
{
  RCLCPP_INFO(get_logger(), "Init Everybot Node Main");
...
Everybot::Wheels * Everybot::get_wheels()
{
  return &wheels_;
}

Everybot::Motors * Everybot::get_motors()
{
  return &motors_;
}

void Everybot::init_dynamixel_sdk_wrapper(const std::string & usb_port)
{
...
void Everybot::check_device_status()
{
...
void Everybot::publish_timer(const std::chrono::milliseconds timeout)
{
...
void Everybot::heartbeat_timer(const std::chrono::milliseconds timeout)
{
...
void Everybot::parameter_event_callback()
{
...
void Everybot::cmd_vel_callback()
{
