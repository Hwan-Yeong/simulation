...
using everybot::everybot::sensors::SensorState;
...
: Sensors(nh),
  ...
  sonar_(sonar)
{
  pub_ = nh->create_publisher<everybot_msgs::msg::SensorState>(topic_name, this->qos_);
...
{
  auto msg = std::make_unique<everybot_msgs::msg::SensorState>();
